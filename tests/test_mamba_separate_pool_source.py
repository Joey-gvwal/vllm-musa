...
def test_mamba_state_capacity_is_per_group_not_global_block_ids():
    source = _read("0081-MUSA-separate-mamba-state-BlockPool.patch")
...
def test_each_mamba_group_gets_an_isolated_local_block_pool():
    source = _read("0082-MUSA-vllm.v1.core.kv_cache_coordinator-separate-mamb.patch")
...
def test_mamba_pool_count_is_documented_as_per_group_address_space():
    source = _read("0080-MUSA-vllm.v1.kv_cache_interface-separate-mamba-pool-.patch")
