...
def test_musa_fused_moe_shape_inventory_is_disabled_by_default(
    ...
    monkeypatch.delenv(
        "VLLM_MUSA_DEEPSEEK_V4_MOE_SHAPE_INVENTORY", raising=False
    )
    monkeypatch.setenv(
...
def test_musa_fused_moe_shape_inventory_records_bridge_contract(
    monkeypatch, tmp_path
):
    from vllm_musa.model_executor.layers.fused_moe import fused_moe
