...
_MUSA_FP8_SMALL_M_GEMV_ENABLED = (
    os.getenv("VLLM_MUSA_FP8_SMALL_M_GEMV", "0").lower()
    in ("1", "true", "yes", "on")
)
_MUSA_FP8_SMALL_M_GEMV_MAX_M = _read_int_env(
    "VLLM_MUSA_FP8_SMALL_M_GEMV_MAX_M", 3
)
