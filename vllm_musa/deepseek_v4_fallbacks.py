...
DEEPSEEK_V4_CORRECTNESS_FALLBACK_DEFAULTS = {
    "VLLM_MUSA_ENABLE_MXFP4_MOE_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_MHC_PRENORM_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_FP8_GROUP_QUANT_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_FUSED_INV_ROPE_FP8_QUANT_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_FP8_EINSUM_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_TOPK_SOFTPLUS_SQRT_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_DEEPSEEK_V4_COMPRESSOR_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_FUSED_INDEXER_Q_ROPE_QUANT_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_SPARSE_ATTN_INDEXER_FALLBACK": "1",
    "VLLM_MUSA_ENABLE_TORCH_DEEPSEEK_V4_CACHE_FALLBACK": "1",
    "VLLM_MUSA_SPARSE_INDEXER_FALLBACK_TOPK": "16",
    "VLLM_MUSA_MXFP4_NAIVE_GROUPED_MOE_IMPL": "native",
}
