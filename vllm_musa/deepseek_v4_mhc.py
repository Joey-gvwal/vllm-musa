...
def _select_mhc_pre_big_fuse_prenorm_impl(
    ...
    # Decode and long-prefill MHC pre consume split-K partials directly in the
    # big-fuse kernel.  The Mate DeepGEMM prenorm kernel has shown intermittent
    ...
    # stable TileLang partial path for those K=16384 edge shapes while leaving
    # mid-size MHC prefill and grouped MoE on DeepGEMM.
